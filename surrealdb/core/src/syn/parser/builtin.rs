...
> = phf_map! {
		...
		UniCase::ascii("set::is_disjoint") => (PathKind::Function, None),
		UniCase::ascii("set::is_empty") => (PathKind::Function, None),
		UniCase::ascii("set::is_subset_of") => (PathKind::Function, None),
		UniCase::ascii("set::is_superset_of") => (PathKind::Function, None),
