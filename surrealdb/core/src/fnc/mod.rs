...
pub fn synchronous(
	...
	dispatch!(
		...
		"set::is_disjoint" => set::is_disjoint,
		"set::is_empty" => set::is_empty,
		"set::is_subset_of" => set::is_subset_of,
		"set::is_superset_of" => set::is_superset_of,
		"set::join" => set::join,
		"set::last" => set::last,
		"set::len" => set::len,
		"set::max" => set::max,
...
pub async fn idiom(
	...
	match value {
		Value::Set(x) => {
			...
			"is_disjoint" => set::is_disjoint,
			"is_empty" => set::is_empty,
			"is_subset_of" => set::is_subset_of,
			"is_superset_of" => set::is_superset_of,
			"len" => set::len,
			"remove" => set::remove,
			"union" => set::union,
				//
